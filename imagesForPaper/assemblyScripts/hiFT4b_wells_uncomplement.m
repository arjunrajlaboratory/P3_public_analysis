function [overlay] = hiFT4b_wells(dataTopDir, projectTopDir, imageSubdir)
...
imwrite(tmr_SHC002, [outFolder, 'SHC002_AlkPhos.tiff']);
...
imwrite(tmr_ZNF652, [outFolder, 'ZNF652_AlkPhos.tiff']);
...
imwrite(tmr_ATOH8, [outFolder, 'ATOH8_AlkPhos.tiff']);
...
imwrite(tmr_KLF13, [outFolder, 'KLF13_AlkPhos.tiff']);
...
imwrite(tmr_ZBTB38, [outFolder, 'ZBTB38_AlkPhos.tiff']);
...
imwrite(tmr_CERS2, [outFolder, 'CERS2_AlkPhos.tiff']);
