function [] = IAMHCF22_subset_spotsAndCentroids(dataTopDir, outDir)


experimentDir = 'transdiff/20190314_IAMHCF22-subset/';
...
%     results.experiment(:) = repmat({'IAMHCF22-subset'}, size(results, 1),
%     1); % run this line instead of 27 if using MATLAB_2019a
    results.experiment = repmat({'IAMHCF22-subset'}, size(results, 1), 1);
